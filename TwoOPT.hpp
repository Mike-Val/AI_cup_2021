...
int gain(int i, int j, vector<int> &tour, const Problem &P) {
...
int two_opt_loop(const Problem &P, vector<int> &tour, int &len) {
    int n = P.dimension - 1;
...
void two_opt(const Problem &P, vector<int> &tour, int &len) {
    int cross;
    do {
